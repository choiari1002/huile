...
public class ReservationController {
    ...
    public ResponseEntity<Object> getReservationAll(@RequestParam(required = false) String email,
...
//            Page 객체 정의
            ...
            reservationPage = reservationService.findAllByDnameContaining(email, pageable);
