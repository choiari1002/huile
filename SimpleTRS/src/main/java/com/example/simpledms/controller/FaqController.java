...
//    frontend url(파라메터방식) : /{} 매개변수 전송방식 사용했으면 ------> backend @PathVariable
    @GetMapping("/faq")
    public ResponseEntity<Object> getFaqAll(@RequestParam(required = false) String content,
...
//            Page 객체 정의
            Page<Faq> faqPage = faqService.findAllByContentContaining(content, pageable);
